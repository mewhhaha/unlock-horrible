...
declare global {
  ...
  interface HtmxAttributes extends HtmxUtils.HxOnMap {
     ...
     * @since 1.9.0
     */
    ["hx-on"]?: HxTriggers | AnyStr | undefined;
    /**
     * Pushes the URL into the browser location bar, creating a new history entry.
     * @see https://htmx.org/attributes/hx-push-url/
     * @category Core
     */
    ["hx-push-url"]?: BoolStr | AnyStr | undefined;
    /**
     ...
     */
    ["hx-swap"]?: true | HxSwap | AnyStr | undefined;
    /**
     ...
     */
    ["hx-swap-oob"]?: "true" | HxSwap | AnyStr | undefined;
    /**
     ...
     * @category Core
     */
    ["hx-target"]?: HxTarget | AnyStr | undefined;
    /**
     ...
     * @category Extensions
     */
    ["hx-target-error"]?: HxTarget | AnyStr | undefined;
    /**
     ...
     * @since 1.9.6
     */
    ["hx-disabled-elt"]?: "this" | "closest " | AnyStr | undefined;
    /**
     * Control and disable automatic attribute inheritance for child nodes.
     * @see https://htmx.org/attributes/hx-disinherit/
     */
    ["hx-disinherit"]?: "*" | AnyStr | undefined;
    /**
     * Changes the request encoding type.
     * @see https://htmx.org/attributes/hx-encoding/
     */
    ["hx-encoding"]?: "multipart/form-data" | undefined;
    /**
     ...
     */
    ["hx-indicator"]?: "closest " | AnyStr | undefined;
    /**
     * Filters the parameters that will be submitted with a request.
     * @see https://htmx.org/attributes/hx-params/
     */
    ["hx-params"]?: "*" | "none" | "not " | AnyStr | undefined;
    /**
     ...
     */
    ["hx-replace-url"]?: BoolStr | AnyStr | undefined;
    /**
     ...
     */
    ["hx-disable-element"]?: "self" | AnyStr | undefined;
    /**
     * The strategy for merging new head content.
     * @see https://htmx.org/extensions/head-support/
     * @category Extensions
     */
    ["hx-head"]?: "merge" | "append" | "re-eval" | undefined;
    /**
     ...
     * @category Extensions
     */
    ["mustache-template"]?: string | undefined;
    /**
     * The ID of a Mustache `<template>` to render the response with.
     ...
     * @category Extensions
     */
    ["mustache-array-template"]?: string | undefined;
    /**
     * The ID of a Handlebars `<template>` to render the response with.
     * @see https://htmx.org/extensions/client-side-templates/
     * @category Extensions
     */
    ["handlebars-template"]?: string | undefined;
    /**
     * The ID of a Handlebars `<template>` to render the response with.
     * Selected when the response is an array.
     * @see https://htmx.org/extensions/client-side-templates/
     * @category Extensions
     */
    ["handlebars-array-template"]?: string | undefined;
    /**
     ...
     * @category Extensions
     */
    ["nunjucks-template"]?: string | undefined;
    /**
     * The ID of a Nunjucks `<template>` to render the response with.
     * Selected when the response is an array.
     * @see https://htmx.org/extensions/client-side-templates/
     * @category Extensions
     */
    ["nunjucks-array-template"]?: string | undefined;
    /**
     ...
     * @category Extensions
     */
    ["xslt-template"]?: string | undefined;
    /**
     * Include additional data in requests.
     * @see https://htmx.org/extensions/include-vals/
     * @category Extensions
     */
    ["include-vals"]?: string | undefined;
    /**
     ...
     * @category Extensions
     */
    ["data-loading"]?: true | string | undefined;
    /**
     ...
     * @category Extensions
     */
    ["data-loading-class"]?: string | undefined;
    /**
     * Disables this element for the duration of a pending request.
     * @see https://htmx.org/extensions/loading-states/
     * @category Extensions
     */
    ["data-loading-disable"]?: true | undefined;
    /**
     ...
     * @category Extensions
     */
    ["data-loading-class-remove"]?: string | undefined;
    /**
     * Adds `aria-busy="true"` to this element for the duration of a pending request.
     * @see https://htmx.org/extensions/loading-states/
     * @category Extensions
     */
    ["data-loading-aria-busy"]?: true | undefined;
    /**
     ...
     * @category Extensions
     */
    ["data-loading-delay"]?: string | undefined;
    /**
     ...
     * @category Extensions
     */
    ["preload"]?: true | "mousedown" | "mouseover" | AnyStr | undefined;
    /**
     * Opt into image preloading.
     * @see https://htmx.org/extensions/preload/
     * @category Extensions
     */
    ["preload-images"]?: "true" | undefined;
    /**
     * Specify the duration after which this element should be removed.
     * @see https://htmx.org/extensions/remove-me/
     * @category Extensions
     */
    ["remove-me"]?: string | undefined;
    /**
